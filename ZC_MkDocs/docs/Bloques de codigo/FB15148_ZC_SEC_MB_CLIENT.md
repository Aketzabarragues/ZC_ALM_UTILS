...
| `DONE` | `Array[1..8] of Bool` | - | `-` | - |
| `ERROR` | `Array[1..8] of Bool` | - | `-` | - |
...
| `ErrorEnBloque` | `Array[1..8] of Bool` | - | `[8(FALSE)]` | - |
| `DISCONNECT` | `Array[1..8] of Bool` | - | `-` | - |
...
| `s_NumeroError` | `Array[1..8] of UInt` | ✔️ | `-` | - |
