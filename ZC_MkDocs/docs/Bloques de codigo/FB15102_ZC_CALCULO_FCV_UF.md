...
| Nombre | Tipo | Retain | Valor Defecto | Comentario |
|---|---|:---:|---|---|
| `s_SP_Presion` | `Real` | ✔️ | `-` | Calculo interno set point presion |
| `s_old_SP_CaudalConcentrado` | `Real` | ✔️ | `-` | Estado anterior set point caudal concentrado |
| `s_old_SP_FCV` | `Real` | ✔️ | `-` | Estado anterior set point FCV |
...
| `s_TON` | `Array[0..1] of UDT_ZC_DISP_TON` | - | `-` | - |
