...
---
# FB FB15106_ZC_CALCULO_LIMPIEZA_4_MODULOS
...
| Nombre | Tipo | Retain | Valor Defecto | Comentario |
|---|---|:---:|---|---|
| `s_PorcentajeSalida1` | `Real` | ✔️ | `-` | - |
| `s_PorcentajeSalida3` | `Real` | - | `-` | - |
| `s_PorcentajeRestante` | `Real` | ✔️ | `-` | - |
| `s_CalculoTiempoSalida2` | `Int` | ✔️ | `-` | - |
| `s_CalculoTiempoSalida3` | `Int` | - | `-` | - |
| `s_CalculoTiempoRestante` | `Int` | ✔️ | `-` | - |
| `s_TiempoSalida2` | `Int` | ✔️ | `-` | - |
| `s_TiempoSalida3` | `Int` | - | `-` | - |
| `S_TON` | `UDT_ZC_DISP_TON` | - | `-` | - |
