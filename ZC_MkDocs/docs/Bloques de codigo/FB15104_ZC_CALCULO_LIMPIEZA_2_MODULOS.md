---
title: FB15104_ZC_CALCULO_LIMPIEZA_2_MODULOS
---
# FB FB15104_ZC_CALCULO_LIMPIEZA_2_MODULOS
...
| Nombre | Tipo | Retain | Valor Defecto | Comentario |
|---|---|:---:|---|---|
| `s_PorcentajeMinimoTodosModulos` | `Real` | ✔️ | `20.0` | Set Point (%) minimo para limpieza de todos los modulos |
| `s_PorcentajeModulo1` | `Real` | ✔️ | `-` | - |
| `s_PorcentajeRestante` | `Real` | ✔️ | `-` | - |
| `s_CalculoTiempoModulo2` | `Int` | ✔️ | `-` | - |
| `s_TiempoModulo1` | `Int` | ✔️ | `-` | - |
