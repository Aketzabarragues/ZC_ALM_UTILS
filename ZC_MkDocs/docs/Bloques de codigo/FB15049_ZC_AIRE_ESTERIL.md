...
| `Usuario` | `String[25]` | ✔️ | `-` | Usuario actual |
| `MinutoAlarma` | `USInt` | - | `-` | - |
...
| `s_Etapa` | `Int` | ✔️ | `-` | Etapa actual |
| `s_NumeroEsterilizaciones` | `Int` | ✔️ | `-` | Numero de esterilizaciones |
| `S_NumeroDiasEsterilizacion` | `Int` | - | `-` | Numerpo de dias con filtro esterilizado |
| `s_TiempoEtapa` | `UDT_ZC_PRO_TIEMPO_ETAPA` | ✔️ | `-` | Tiempo de etapa |
| `Pulsadores` | `Struct
         Habilitar { S7_SetPoint` | - | `'False'} : "UDT_ZC_PULSADOR"` | - |
| `Mantenimiento` | `UDT_ZC_PULSADOR` | - | `-` | - |
| `TiempoEsterelizado` | `UDT_ZC_CONTADOR_TIEMPO` | ✔️ | `-` | - |
| `s_PasswordCalculado` | `UInt` | - | `-` | Contraseña calculada de mantenimiento |
| `s_PasswordHMI` | `UInt` | - | `-` | Contraseña calculada de mantenimiento |
| `s_MostrarAlarmaMto` | `Bool` | - | `-` | - |
